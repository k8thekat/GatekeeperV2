...
class Copy_To_Banner_Button(Button):
    ...
    def __init__(self, *,  edited_banner: Edited_DB_Banner ) -> None:
        super().__init__(style = ButtonStyle.blurple, label = "Copy to..", emoji= ":arrow_right:")
...
class Copy_To_All_Banner_Button(Button):
    ...
    def __init__(self, banner_message: discord.Message, edited_banner: Edited_DB_Banner, amp_handler: AMP_Handler.AMPHandler, amp_server: AMPInstance, style= discord.ButtonStyle.secondary):
        super().__init__(style=style, label='Copy to All', custom_id='Copy to All')
        self._banner_message = banner_message
        self._edited_db_banner = edited_banner
        self._amp_handler: AMP_Handler.AMPHandler = amp_handler
        self._amp_instances = amp_handler.AMP_Instances
