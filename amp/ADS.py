...
from ampapi.ads import ADSInstance
from ampapi.instance import AMPInstance
...
class AMP_ADS(AMP_API):
    ...
    _ampModules: list = []  # All Instance/Module types we currently have
    ...
    # TODO - Possible remove/drop all these attributes.
    # permission attrs
    AMPUSER_id: str
    AMPUSER_info: dict
