'''
   ...
   This file is part of Gatekeeper, the AMP Discord Bot.
...
class DBHandler():
    def __new__(cls, *args, **kwargs):
        if not hasattr(cls, "_instance"):
            cls._instance = super(DBHandler, cls).__new__(
                cls, *args, **kwargs)
...
class Database:
    ...
    def GetServer(self, InstanceID: Union[str, None] = None, ServerID: Union[str, None] = None):
    ...
    def GetRegexPattern(self, ID: Union[int, None] = None, Name: Union[str, None] = None) -> Union[dict[str, str], bool]:
    ...
    def GetAllRegexPatterns(self) -> dict[str, dict[str, str]]:
    ...
    def Get_BannerGroup(self, name: str = None, ID: int = None) -> Union[str, None]:
        """Selects a Banner Group Table matching the `name` or `ID` provided."""
    ...
    def Add_Server_to_BannerGroup(self, banner_groupname: str, instanceID: str) -> Union[None, bool]:
    ...
    def Remove_Server_from_BannerGroup(self, banner_groupname: str, instanceID: str) -> None:
    ...
    def Get_all_Servers_for_BannerGroup(self, banner_groupname: str) -> list[DBServer]:
        """Gets all the Servers for a BannerGroup and returns a DBServer List"""
        banner_id = self.Get_BannerGroup(name=banner_groupname)
        if banner_id == None:
            return None

        (row, cur) = self._fetchall("SELECT ServerID FROM BannerGroupServers WHERE BannerGroupID=?", (banner_id,))
        if not row:
            return None
        servers = []
        for entry in row:
            cur_server = self.GetServer(ServerID=entry["ServerID"])
            if cur_server != None and cur_server not in servers:
                servers.append(cur_server)
        cur.close()
        return servers

    def Add_Channel_to_BannerGroup(self, banner_groupname: str, channelid: int, guildid: int) -> bool:
    ...
    def Remove_Channel_from_BannerGroup(self, channelid: int, guildid: int) -> None:
    ...
    def Get_Channels_for_BannerGroup(self, banner_groupname: str) -> list[str]:
    ...
    def Add_Message_to_BannerGroup(self, banner_groupname: str, channelid: int, messageid: int) -> None:
    ...
    def Remove_Message_from_BannerGroup(self, messageid: int) -> None:
    ...
    def Get_Messages_for_BannerGroup(self, banner_groupname: str) -> dict[str, list]:
...
class DBServer:
    ...
    def __init__(self, db: Database, ID: int = None, InstanceID: str = None, InstanceName: str = None, FriendlyName: str = None):
        ...
        self.DisplayName: Union[str, None]
        self.Description: Union[str, None]
        self.Host: str
        self.Whitelist: bool
        self.Whitelist_disabled: bool
        self.Donator: bool
        self.Console_Flag: bool
        self.Console_Filtered: bool
        self.Console_Filtered_Type: bool
        self.Discord_Console_Channel: Union[int, None]
        self.Discord_Chat_Channel: Union[int, None]
        self.Discord_Chat_Prefix: Union[str, None]
        self.Discord_Event_Channel: Union[int, None]
        self.Discord_Role: Union[int, None]
        self.Avatar_url: Union[str, None]
        self.Hidden: bool

        server_attr: dict[str, Union[None, str, bool, int]] = {
            'DisplayName': None,
            'Description': None,
            'Host': '192.168.1.1',
            'Whitelist': False,
    ...
    def GetServerRegexPatterns(self) -> dict[str, dict[str, str]]:
...
class DBConfig:
    ...
    def __getattribute__(self, name) -> Union[int, None]:
...
class DBBanner:
    ...
    def __setattr__(self, name: str, value):
        ...
        # If the attr starts with an underscore, dont update the attr.
